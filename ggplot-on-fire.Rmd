...
### Step 3: Apply the new palette to a ggplot `r emo::ji("graph")`  
...
To this `r emo::ji("fire")` ggplot `r emo::ji("fire")`:
```{r, warning=FALSE}
penguins %>%
...
For more information on the package vignette, go to: https://github.com/zumbov2/colorfindr  
